...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $subordinates = User::where('accountant_id', '=', $accId)->get();
        $clients = $subordinates->where('role_id', '=', Role::CLIENT)->where('suspended', '=', 0);
        $staff_count = $subordinates->whereIn('role_id', [Role::LIAISON, Role::CLERK])->count();
    ...
    private function getClientTypesToCountMap(Collection $clients)
    {
