    ...
    <section class="clients-submit">
        ...
        <div class="container dual-section">
            ...
            <div class="section-text">
                ...
                <p>Robotic Process Automation (RPA) is an innovative technology that automates manual, recurring
                    processes. Unlike a physical robot in industry, RPA does not use machines, but so-called software
                    bots...</p>
    ...
    <section class="client-reports">
        <div class="container dual-section reverse">
            ...
            <div class="section-text">
                ...
                <p>BuWise is able to improve your Bookkeeping process by doing the following: First, we automate your
                    invoice management. Simply upload an invoice, and our software bots will instantly scan its details
                    and create a complete journal entry, including the correct account names and groups. Next, we
                    meticulously check and verify these entries to ensure unparalleled accuracy before they're posted.
                    After being processed as a Journal Entry, Ledger Entry, it will now generate a Report.
                </p>
