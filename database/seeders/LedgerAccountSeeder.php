...
class LedgerAccountSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('ledger_accounts')->insert([
            ...
            ['code' => 406, 'account_group_id' => AccountGroup::REVENUE, 'name' => 'Dividends Revenue'],
            ['code' => 407, 'account_group_id' => AccountGroup::REVENUE, 'name' => 'Earnings from Investments'],
            ['code' => 408, 'account_group_id' => AccountGroup::REVENUE, 'name' => 'Interest Revenue'],
            ['code' => 409, 'account_group_id' => AccountGroup::REVENUE, 'name' => 'Sinking Fund Earnings'],
